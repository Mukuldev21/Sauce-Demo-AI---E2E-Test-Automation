...
test.describe('Product Tests', () => {
    ...
    test('TC-010: Product sorting - Name A to Z @regression @products', async ({ page }) => {
        // Sort by name A to Z
    ...
    test('TC-011: Product sorting - Price low to high @regression @products', async ({ page }) => {
    ...
    test('Product sorting - Name Z to A @regression @products', async ({ page }) => {
        // Sort by name Z to A
    ...
    test('Product sorting - Price high to low @regression @products', async ({ page }) => {
    ...
    test('TC-012: Product detail view @regression @products', async ({ page }) => {
        // Click on a product
    ...
    test('Add to cart from product detail page @regression @products', async ({ page }) => {
