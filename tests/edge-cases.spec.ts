...
test.describe('Edge Cases Tests', () => {
    ...
    test('TC-014: Reset app state @regression @edge', async ({ page }) => {
    ...
    test('TC-015: Problem user - visual issues @regression @edge @problem-user', async ({ page }) => {
    ...
    test('TC-016: Performance glitch user @regression @performance', async ({ page }) => {
        ...
        await expect(inventoryPage.cartBadge).toBeVisible({ timeout: 10000 });
        await expect(inventoryPage.cartBadge).toHaveText('1');
    ...
    test('Error user - checkout failure @regression @edge', async ({ page }) => {
        // Login as error user
    ...
    test('Visual user - image differences @regression @edge', async ({ page }) => {
