...
test.describe('Checkout Tests', () => {
    ...
    test('TC-008: Complete checkout - single item @smoke @e2e @checkout', async ({ page }) => {
        // Add item to cart
    ...
    test('TC-009: Checkout validation - missing information @regression @negative @checkout', async ({ page }) => {
    ...
    test('TC-020: Multiple items - price calculation @regression @checkout @e2e', async ({ page }) => {
    ...
    test('TC-019: Browser back button during checkout @edge @checkout', async ({ page }) => {
